...
int main()
{
  ...
  char* str3;
  char* str4;
  str3 = (char*)calloc(80,sizeof(char));
  str4 = (char*)calloc(80,sizeof(char)); 
  //any of the latest two callocs could interfere with the memory freed up through the str2 pointer
