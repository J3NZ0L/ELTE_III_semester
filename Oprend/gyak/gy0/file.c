...
int main(int argc,char** argv){
 ...
 if (argc!=3){perror("You have to use the program with two arguments, the file names copy_from copy_to");exit(1);}
 int f,g;
 ...
 //O_RDONLY=only for reading,O_WRONLY-only for writing, O_RDWR for both at once
