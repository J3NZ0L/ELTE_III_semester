# TODOS
- [x] create logic of rotated displayment of tiles according to inner state
    - [x] create a css selector or set of selectors which do the rotation of the images in the displaying segmetn
