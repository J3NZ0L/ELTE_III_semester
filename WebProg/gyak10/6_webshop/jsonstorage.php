<?php
include_once "jsonio.php"; //hasonlo mint C header guard, megmondja h csak egyszer legyen includeolva ha includeoljuk tobbszor is mashol

class JsonStorage{
    private $io;
    private $filename;
    public function __construct(string $filenam)
    {
        $this->io = new JsonIO();
